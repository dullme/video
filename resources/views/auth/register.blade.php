                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <input id="username" type="text" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" required autofocus placeholder="用户名">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required placeholder="密码">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 text-right">
                                ...
                                <a style="display: block;margin-top: 1rem;color: white;" href="{{ url('/login') }}">去登陆</a>
                            </div>
                        </div>
                    </form>
                </div>
